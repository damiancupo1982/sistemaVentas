    ...
    (set, get) => ({
      ...
      refreshData: async () => {
        ...
        try {
          ...
          const [products, movements, sales, courts, courtServices, reservations, courtBills, expenses, adminTurns, turnClosures, activeTurn] = await Promise.all([
            getProducts(),
            getMovements(),
            getSales(),
            getCourts(),
          ...
          set({ products, movements, sales, courts, courtServices, reservations, courtBills, expenses, adminTurns, turnClosures, activeTurn });
        } catch (error) {
